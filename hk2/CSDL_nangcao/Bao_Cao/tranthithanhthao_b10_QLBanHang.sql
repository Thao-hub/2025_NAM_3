...
-- PHIEU BAI TAP 1 VA PHIEU BAI TAP 2 - CSDL QLBANHANG

SET SERVEROUTPUT ON;

PROMPT ===== TAO BANG VA DU LIEU MAU - QLBANHANG =====
...
PROMPT ===== PHIEU BAI TAP 2 =====

-----a. Package đếm số dòng cho Compound Trigger – pkg_state
